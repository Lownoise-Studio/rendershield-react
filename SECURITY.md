...
The latest minor and patch releases of the current major version are supported for security updates.
Older major versions may not receive security fixes.
...
Publicly disclose the issue with credit (if desired)
Scope
